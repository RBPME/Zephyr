...
<Sidebar>
    <SidebarWrapper class="fixed w-64 h-screen top-0">
        <SidebarGroup>
            ...
            <SidebarItem label='Enheder' href="/Enheder" active={activeUrl === '/Enheder'}>
                <svelte:fragment slot="icon">
