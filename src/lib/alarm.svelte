<script lang="ts">
  ...
  export let hrs: number;
  export let min: number;
</script>

<div
  class="border p-6 rounded-lg bg-gray-50 dark:bg-gray-800 border-gray-200 shadow dark:border-gray-700 flex flex-row w-full"
>
